            ...
            <nav>
                ...
                <div className="mobile__nav-container mb__nav-container-visible">
                    <ul className="ul-nav flex__ul">
                        ...
                        <li className="li-nav flex__li-item"> <a href="/#portfolio" className="navLink"> Portfolio </a></li>
                        <li className="li-nav flex__li-item"> <a href="/#!" className="navLink"> Contact  </a> </li>
                    </ul>
                </div>
            </nav>
        </div>
